  ...
  try(
    lapply(
      funcFileList(dtFolder = dtFolder,pgName = "ERP_Data", pattern = funcConcat("*",pgName,".xls")),function(f){
        ...
        names(dt) <- c("wfSpecCap","wfSpecDF","wfSpecLC","wfSpecZESR","wfAgeVoltSet","wfPriorWfFormId","wfNakedProductSpec","wfFormId","wfOrderId","wfOrderSeries","wfOrderBatchId","wfOrderRMId","wfFormERPName","wfOrderSpec","wfOrderDim","wfOrderBatchQty","wfOrderTotalQty","wfSalesOrderQty","wfClientId","wfOrderFormNote","wfOrderNote","wfOrderBOMNote","wfSalesOrderNote","wfOrderDate","wfOrderStartDate","wfOrderEstFinishDate","wfOrderDeliveryDate","wfOrderTK","wfOptMachineId","wfRMFoilPosName","wfRMFoilNegName","wfRMPaperName","wfRMPinPosName","wfRMPinNegName","wfRMGlueName","wfRMSolName","wfRMShellName","wfRMPlasticName","wfRMCoverName","wfRMUpBeltName","wfRMDownBeltName","wfRMBaseName","wfRMCircleName","wfRMFoilPosSerial","wfRMFoilNegSerial","wfRMPaperSerial","wfRMGlueSerial","wfRMSolSerial","wfRMPinPosSerial","wfRMPinNegSerial","wfRMPlasticSerial","wfRMShellSerial","wfRMCoverSerial")
