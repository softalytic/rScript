  ...
  try(
    lapply(
      funcFileList(dtFolder = dtFolder,pgName = "ERP_Data", pattern = funcConcat("*",pgName,".xls")),function(f){
        ...
        # dt <- data.table(read.xlsx2("~/rawData/ERP_Data/20171123_ERP.xls",sheetIndex = 1))
        # Backup code for testing
        # dt <- data.table(read.xlsx2("~/rawData/ERP_Data/20171110_vtERP.xls",sheetIndex = 1))
        ...
        names(dt) <- c("wfSpecCap","wfSpecDF","wfSpecLC","wfSpecZESR","wfTotalBatchQty","wfRow","wfAgeVoltSet","wfPriorWfFormId","wfNakedProductSpec","wfFormId","wfOrderId","wfOrderSeries","wfOrderBatchId","wfOrderRMId","wfFormERPName","wfOrderSpec","wfOrderDim","wfOrderBatchQty","wfOrderTotalQty","wfSalesOrderQty","wfClientId","wfSalesNote","wfOrderFormNote","wfOrderNote","wfOrderBOMNote","wfSalesOrderNote","wfFormDeployDate","wfOrderDate","wfOrderStartDate","wfOrderEstFinishDate","wfOrderDeliveryDate","wfOrderTK","wfCurrentProcess","wfCurrentProcessName","wfOptMachineId","wfProdDate","wfExportDate","wfExportNum","wfRMFoilPosName","wfRMFoilPosQty","wfRMFoilPosWidth","wfRMFoilPosLength","wfRMFoilNegName","wfRMFoilNegQty","wfRMFoilNegWidth","wfRMFoilNegLength","wfRMPaperName","wfRMPaperQty","wfRMPaperWidth","wfRMPaperLength","wfRMPinPosName","wfRMPinPosQty","wfRMPinNegName","wfRMPinNegQty","wfRMGlueTapeName","wfRMGlueName","wfRMSolName","wfRMSolQty","wfRMShellName","wfRMShellQty","wfRMPlasticName","wfRMPlasticQty","wfRMCoverName","wfRMCover","wfRMCoverQty","wfRMUpBeltName","wfRMDownBeltName","wfRMBaseName","wfRMCircleName","wfRMFoilPosSerial","wfRMFoilNegSerial","wfRMPaperSerial","wfRMGlueSerial","wfRMSolSerial","wfRMPinPosSerial","wfRMPinNegSerial","wfRMPlasticSerial","wfRMShellSerial","wfRMCoverSerial")
